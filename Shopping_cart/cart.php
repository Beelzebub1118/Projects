            ...
            <tbody>
                <?php foreach ($_SESSION['cart'] as $index => $item): ?>
                    <tr>
                        ...
                        <td>
                        <a href="remove_confirm.php?id=<?php echo urlencode($item['id'] ?? ''); ?>&size=<?php echo urlencode($item['size'] ?? ''); ?>&quantity=<?php echo urlencode($item['quantity'] ?? ''); ?>" class="btn btn-danger">🗑️</a>
